  ...
  return (
    <div>
      ...
      <div className="hotelContainer">
        ...
        <i className="fa-solid fa-circle-left arrow" onClick={() => handleMove("l")}></i>
        <div className="sliderWrapper">
          <img src={photos[slideNumber].src} alt="slide" className="sliderImg"></img>
        </div>
