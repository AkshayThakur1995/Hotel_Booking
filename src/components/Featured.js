...
import "./Featured.css"
function Featured() {
  const  {data,loading,error} = useFetch("http://localhost:8000/hotels/find/countByCity?cities=delhi,himachal")
  console.log(data)
  return (
    <>
    {loading ? <h1>data is loading</h1> :(<div className='featured'>
